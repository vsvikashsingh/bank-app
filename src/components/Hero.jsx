...
{/* get started section */}
      <div className="flex flex-row justify-between items-center w-full">
        ...
        text-white ss:leading-[100px] laeding-[75px]">The Next 
...
<h1 className="font-poppins font-semibold ss:text-[68px] text-[52px] 
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
          Eligendi doloremque ut earum incidunt animi expedita doloribus, 
          facilis aperiam commodi aliquam cum perspiciatis fugiat velit 
          nulla beatae, delectus quas tenetur necessitatibus!</p>
    </div>
